...
![alt text](/AutographaLiveImages/Settings/export-for-paratext-fig-2.3.5.7.jpg 'Export to paratext')
...
![alt text](/AutographaLiveImages/Settings/warning-before-exporting-to-paratext-fig-2.3.5.8.jpg 'Warning before exporting to Paratext')
...
![alt text](/AutographaLiveImages/Settings/book-exported-to-paratext-confirmation-fig-2.3.5.9.jpg 'Book exported to paratext confirmation')
...
![alt text](/AutographaLiveImages/Settings/error-message-for-exporting-to-paratext-fig-2.3.5.10.jpg 'Book exported to paratext confirmation')
