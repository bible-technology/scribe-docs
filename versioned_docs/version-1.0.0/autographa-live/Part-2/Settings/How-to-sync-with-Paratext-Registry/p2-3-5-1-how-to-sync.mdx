...
<img src="/AutographaLiveImages/Settings/sync-fig-2.3.5.1.jpg" width="100%" alt="Sync"/>
...
<img src="/AutographaLiveImages/Settings/sync-credentials-fig-2.3.5.2.jpg" width="100%" alt="Sync Credentials"/>

<div align='center' style={{ fontStyle: 'Italic' }}>
	Figure 2.3.5.2- Sync Credentials
</div>

-   Type your paratext account username under the **Username** field (refer- [_Sync_](../../../Part-1/Getting-Started/Autographa-Live-User-Interface-Overview/Settings-User-Interface/p1-2-3-7-sync.mdx))
