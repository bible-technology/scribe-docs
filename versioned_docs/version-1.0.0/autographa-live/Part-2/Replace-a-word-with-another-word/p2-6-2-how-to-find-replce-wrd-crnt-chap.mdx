...
<img src="/AutographaLiveImages/Replace-word/replace-button-current-chapter-fig-2.6.1.2.jpg" width="100%" alt="Replace button"/>

<div align='center' style={{ fontStyle: 'Italic' }}>Figure 2.6.1.2-Replace button</div>
