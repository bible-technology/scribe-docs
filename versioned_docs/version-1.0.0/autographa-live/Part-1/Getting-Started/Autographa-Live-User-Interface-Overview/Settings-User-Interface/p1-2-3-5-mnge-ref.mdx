...
<img src="/AutographaLiveImages/Getting_Started/manage-reference-texts-fig-1.2.1.7.jpg" width='100%' alt='anage Reference Texts screen'/>

<div align='center' style={{ fontStyle: 'Italic' }}
>Figure 1.2.1.7 - Manage Reference Texts screen</div>

_Table 1.2.6_ explains the information displayed on the Manage Reference Texts screen.
