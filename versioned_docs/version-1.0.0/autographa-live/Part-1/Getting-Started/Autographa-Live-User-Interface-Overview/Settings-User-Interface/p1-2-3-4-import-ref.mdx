...
<img src="/AutographaLiveImages/Getting_Started/import-reference-text-fig-1.2.1.6.jpg" width="100%" alt="Import Reference Text screen"/>
...
_Table 1.2.5_ explains the five details of the import text that you enter.
