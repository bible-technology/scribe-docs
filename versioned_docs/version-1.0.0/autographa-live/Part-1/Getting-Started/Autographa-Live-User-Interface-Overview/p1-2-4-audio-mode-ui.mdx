...
<img src="/AutographaLiveImages/Getting_Started/audio-mode-ui-fig-1.2.1.10.jpg" width="100%" alt="Audio mode interface"/> 


<div align='center' style={{ fontStyle: 'Italic' }}>
	Figure 1.2.1.10 - Audio mode interface
</div>

_Table 1.2.8_ describes the **Audio Mode** interface in detail.
...
<div align='center' style={{ fontStyle: 'Italic' }}>
	Table 1.2.8 - Audio mode interface
</div>
