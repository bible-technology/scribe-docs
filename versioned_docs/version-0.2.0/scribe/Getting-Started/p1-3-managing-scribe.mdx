...
- Keep the application updated with the new releases of the latest version of **Scribe** available at https://github.com/friendsofagape/autographa/releases. You can also get the links to the latest version from the website [autographa.org](https://www.autographa.org/).
