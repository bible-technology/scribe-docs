...
sidebar_label: ऑफलाइन मर्ज
title: ऑफलाइन मर्ज
---

"अधिक जानकारी के लिए प्रोजेक्ट आयात करें पृष्ठ पर जाएं, जहाँ पर प्रोजेक्ट को कैसे आयात करने के बारे में जानकारी दी गई है।"
...
- प्रोजेक्ट पेज के ऊपरी दाएं कोने में **आयात** <img src="/assets/import01.png" width="80px" alt=""/> पर क्लिक करें।
...
- एक रिप्लेस स्रोत संवाद बॉक्स खुलेगा जिसमें रिप्लेस और मर्ज करने के विकल्प होंगे। <i>(only for OBS)</i> 
...
<h3>संघर्षों को सुलझाने के लिए कदम</h3>
...
- अनुभाग के ऊपर प्रदान की गई विकल्पों में से कोई एक विकल्प चुनें ताकि पुष्टि कर सकें। ( <img src="/assets/alloursalltheirs.png" width="30%" alt=""/> )
- **हमारे** (पहले से ही प्रयोक्ता के पास परियोजना में है)
...
- **सभी हमारे** (सभी विवाद हमारे परिवर्तन के साथ हल किए जाएंगे)
- **सभी उनके** (सभी विवाद उनके परिवर्तन के साथ हल किए जाएंगे)
