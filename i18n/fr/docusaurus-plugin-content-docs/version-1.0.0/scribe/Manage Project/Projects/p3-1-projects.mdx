...
<img src="/0.8.1/fr_project_listing_page.png"  width="1000px" alt="project listing"/>

### Étoiles et non étoilées ###

-   Cliquez sur l'**étoile** à côté du nom du projet		 
-   Ceci épinglera le projet en haut de la liste
    <video controls src="/0.5.5/en-staring-project.mov" width="100%" type="video/mov"></video>
...
<video controls src="/0.5.5/en-serachsort.mov" width="100%" type="video/mov"></video>
