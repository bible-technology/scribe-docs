...
3. **<img src="/1.0.0/blue.png" width="15px" alt=""/> Bleu** – **Doublure détectée** : Le livre a été sélectionné plusieurs fois ou est déjà inclus dans le lot et ne peut pas être réimporté.
4. **<img src="/1.0.0/green.png" width="15px" alt=""/> Vert** – **Livre valide** : Le fichier est dans le périmètre et peut être importé avec succès.
...
<img src="/1.1.0/en_importbook.png" width="1000px" /> 