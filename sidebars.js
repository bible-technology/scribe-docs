  ...
  autographa: [
    {
      ...
      items: [
        'autographa/About-this-guide/p0-1-objective',
        'autographa/About-this-guide/p0-2-how-use-guide',
        'autographa/About-this-guide/p0-3-supported-sys',
        'autographa/About-this-guide/p0-4-techncl-support',
      ],
    },
    {
      type: 'category',
      ...
      items: [
        'autographa/Getting-Started/p1-1-what-is-a',
        'autographa/Getting-Started/p1-2-how-to-install',
        'autographa/Getting-Started/p1-3-managing-autographa',
      ],
    }, {
      type: 'category',
      label: 'How To',
      items: [
        "autographa/How-To/p2-1-overview",
        "autographa/How-To/p2-2-sign-in",
        {
          "Project Listing": [
            ...
            "autographa/How-To/Project-Listing/p2-3-3-editing-project"
          ],
        },
        {
          "Text Translation Mode": [
            "autographa/How-To/Text-Translate-Mode/p2-4-1-t-plane",
