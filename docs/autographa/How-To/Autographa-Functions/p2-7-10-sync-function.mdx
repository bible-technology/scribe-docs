...
<video controls src="/AutographaV2-1-0/syncaproject.mov" width="100%" type="video/mp4"/>
...
- Click on the project that you want to merge from the remote server to the local system.
- Click on the offline sync button.
