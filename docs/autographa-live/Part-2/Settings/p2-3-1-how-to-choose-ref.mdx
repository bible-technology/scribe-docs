...
-   Click on **Reference Text Menu** (refer [_Main Workspace User Interface_](../../Part-1/Getting-Started/Autographa-Live-User-Interface-Overview/p1-2-2-main-wrkspace-ui.mdx) on the **Reference pane**.
