---
id: p2-3-3-advanced-settings.mdx.md
...
- **Versification Scheme**
  ...
  -  **Autographa** supports popular versification schemes used in the Bible. 

- **License**

  -  This feature allows users to select a domain 
  -  **Autographa** encourages users to select a public domain so that Bible translations may be accessible to the general public.
  -  To save changes, make sure to click on the **Save** button on the bottom left side of the screen.

<video controls src="/autographaAssetsV2/how-to/advanced-settings.mov" width="100%" type="video/mov"/>