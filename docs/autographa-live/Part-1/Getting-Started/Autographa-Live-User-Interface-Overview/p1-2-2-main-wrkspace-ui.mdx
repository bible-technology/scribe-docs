...
<div align='center' style={{ fontStyle: 'Italic' }}>
	Figure 1.2.1.1 - Main workspace user inference of Autographa Live
</div>

_Table 1.2.1_ explains different **menus**, **buttons** and **options** in the main workspace user interface.
...
<div align='center' style={{ fontStyle: 'Italic' }}>
	Table 1.2.1 - Buttons and options in main workspace user interface
</div>
