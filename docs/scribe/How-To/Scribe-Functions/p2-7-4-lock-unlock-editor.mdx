...
- Click on the lock icon <img src="/scribeAssetsV2/how-to/lock.png" width="30px" alt=""/> on the top-right corner of the **Editor column.** 
...
<video controls src="/scribeAssetsV2/how-to/lock-unlock.mov" width="100%" type="video/mov"/>